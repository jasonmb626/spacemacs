...
before packages are loaded."
  ...
  (add-hook 'org-mode-hook
            (lambda ()
              (interactive)
              (spacemacs/set-leader-keys "RET" 'org-insert-heading)
              (spacemacs/set-leader-keys "miS" 'yas-insert-snippet)
              (spacemacs/set-leader-keys "mis" 'my/org-insert-subheading)
              (evil-local-set-key 'normal (kbd ",iS") 'yas-insert-snippet)
              (evil-local-set-key 'normal (kbd ",is") 'my/org-insert-subheading)
